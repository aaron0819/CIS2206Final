/**
 * Conertible4.java by Aaron Hampson 11/30/13
 * @author Aaron Hampson
 * @version 1.0
 * 
 * Convertible loads convertible4.xml and also handles the onClick function and 
...
public class Convertible4 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.convertible4);
