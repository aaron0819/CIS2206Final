/**
 * Hybrid3.java by Aaron Hampson 11/30/13
 * @author Aaron Hampson
 * @version 1.0
 * 
 * Hybrid loads hybrid3.xml and also handles the onClick function and 
...
public class Hybrid3 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.hybrid3);
