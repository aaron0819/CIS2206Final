/**
 * Luxury5.java by Aaron Hampson 11/30/13
 * @author Aaron Hampson
 * @version 1.0
 * 
 * Luxury loads luxury5.xml and also handles the onClick function and 
...
public class Luxury5 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.luxury5);
