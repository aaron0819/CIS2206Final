/**
 * Conertible2.java by Aaron Hampson 11/30/13
 * @author Aaron Hampson
 * @version 1.0
 * 
 * Convertible loads convertible2.xml and also handles the onClick function and 
...
public class Convertible2 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.convertible2);
