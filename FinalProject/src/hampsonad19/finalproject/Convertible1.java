/**
 * Conertible1.java by Aaron Hampson 11/30/13
 * @author Aaron Hampson
 * @version 1.0
 * 
 * Convertible loads convertible1.xml and also handles the onClick function and 
...
public class Convertible1 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.convertible1);
