/**
 * Sedan1.java by Aaron Hampson 11/30/13
 * @author Aaron Hampson
 * @version 1.0
 * 
 * Sedan loads sedan1.xml and also handles the onClick function and 
...
public class Sedan1 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.sedan1);
