/**
 * SUV4.java by Aaron Hampson 11/30/13
 * @author Aaron Hampson
 * @version 1.0
 * 
 * SUV loads suv4.xml and also handles the onClick function and 
...
public class SUV4 extends Activity {
